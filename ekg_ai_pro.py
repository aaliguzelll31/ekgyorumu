...
# (İçerikler T.C. Sağlık Bakanlığı ASHGM - Hastane Öncesi Tanı ve Tedavi
#  Algoritmaları SB-ASH-Y-07/08/10/11/12 + AKS'ye göre güncellenmiştir.
#  NOT: Yalnızca metin içerikleri değişmiştir, kod iskeleti orijinalle aynıdır.)
# ==============================================================================
TEDAVI_ALGORITMALARI = {
   ...
   (Ön Duvar Kalp Krizi)
📋 RESMİ ÇERÇEVE: Akut Koroner Sendrom + Acil Olgu Yönetimi (SB-ASH-Y-02)
...
⚠️ NABIZ YAVAŞLARSA (Bradikardi - SB-ASH-Y-07):
💊 ATROPİN 0.5 mg IV
   → Doktor orderı ile
   → Maksimum doz: 3 mg
...
• Ağrı artışında EKG tekrarla"""
    ...
    "AF": {
        "aciliyeti": "⚠️ AF - Atriyal Fibrilasyon (Nabızlı Taşikardi SB-ASH-Y-08)",
        "algoritma": """📌 TANI: AF
   (Atriyal Fibrilasyon)
   (Düzensiz Kalp Ritmi)
📋 RESMİ PROTOKOL: SB-ASH-Y-08 (Dar QRS - Düzensiz dalı)
...
1️⃣ HASTA STABİL Mİ?
   (En az biri varsa STABİL DEĞİL)
   1. Senkop, ani bilinç değişikliği
   2. Miyokard iskemisi
   3. Şok bulguları
...
❌ ANSTABİL HASTA:
   ...
   → Kardiyoversiyon HASTANEDE (Doktor onayı)
   ⚡ Senkron şok max 3 kez - Dar QRS: 70-120 J
   💉 Sedasyon: MİDAZOLAM 2-4 mg IV + FENTANİL 50 mcg IV
      ya da MORFİN 2-4 mg IV
...
⛔ HIZ KONTROLÜ (Doktor orderı / KKM):
   • METOPROLOL 5 mg IV
     → Düzelmezse 3 defaya kadar tekrarlanabilir
   • veya DİLTİAZEM 0.25 mg/kg IV
   (Metoprolol, Diltiazem, Amiodaron, Digoksin
    paramedik TEK BAŞINA veremez, order şart)
...
• Nabız hızı >150 → dikkat"""
    ...
    "VT": {
        "aciliyeti": "🚨 KIRMIZI KOD - VT (Ventriküler Taşikardi - SB-ASH-Y-08)",
        "algoritma": """📌 TANI: VT
   (Ventriküler Taşikardi)
📋 RESMİ PROTOKOL: SB-ASH-Y-08 (Geniş QRS dalı)

🔍 EKG: Geniş QRS (>0.12 sn)
   Hız >100/dk
...
❌ NABIZ YOK:
   → KARDİYAK ARREST!
   → VF/Nabızsız VT (SB-ASH-Y-11) protokolüne GİT
   → CPR + DEFİBRİLASYON + Adrenalin
...
❌ ANSTABİL:
   → HEMEN HASTANEYE
   → Yolda defibrilatör HAZIR
   → Sedasyon HAZIR (MİDAZOLAM 2-4 mg IV +
      FENTANİL 50 mcg IV ya da MORFİN 2-4 mg IV)
   ⚡ Senkron kardiyoversiyon max 3 kez
      Geniş QRS ve Düzensiz: 120-150 J
   → Yanıt yoksa: AMİODARON 300 mg IV (10-20 dk)
   → Yanıt yoksa: Kardiyoversiyonu tekrarla
...
⛔ STABİL GENİŞ QRS DÜZENLİ (Doktor orderı / KKM):
   • AMİODARON 300 mg IV / 20-60 dk
   • Dal bloklu SVT ise: dar kompleks gibi tedavi et
   • Torsade de pointes: MAGNEZYUM 2 gr / 10 dk
...
• Kardiyak arrest hazırlığı"""
    ...
    "VF": {
        "aciliyeti": "🚨🚨 KARDİYAK ARREST - VF / Nabızsız VT (SB-ASH-Y-11)",
        "algoritma": """📌 TANI: VF / NABIZSIZ VT
   (Ventriküler Fibrilasyon)
   (Şoklanır Ritim)
📋 RESMİ PROTOKOL: SB-ASH-Y-11
...
2️⃣ CPR (Yüksek Kaliteli):
✓ Hız: 100-120/dk
✓ Derinlik: 5-6 cm
✓ 30 kompresyon : 2 solunum
✓ Kompresyona 10 sn'den fazla ara verme
✓ Kompresyon fraksiyonu en az %60
✓ Göğsün tam gevşemesine izin ver
✓ Hiperventilasyondan kaçın
✓ 2 dakikada bir yer değiştir

3️⃣ DEFİBRİLASYON DÖNGÜSÜ:
⚡ Pedleri yerleştir
   • Ped 1: Sağ klavikula altı
   • Ped 2: Sol koltuk altı
⚡ 1. ŞOK → ara vermeden 2 dk CPR
⚡ 2 DK ARAYLA RİTMİ VE NABZI DEĞERLENDİR
⚡ 2. ŞOK → ara vermeden 2 dk CPR
⚡ 2 DK ARAYLA DEĞERLENDİR
⚡ 3. ŞOK → ara vermeden 2 dk CPR
⚡ "ÇEKİLİN!" bağır, şok ver, hemen basıya dön

⚡ ŞOK ENERJİ DÜZEYİ (ANAHTAR):
   • Firma önerisine göre seç (150-360 J)
   • Bilinmiyorsa EN YÜKSEK düzeyi tercih et
   • Artan doz kullanılıyorsa 4. şoktan sonra
     EN YÜKSEK düzeyden ver

4️⃣ HAVAYOLU:
✓ Ambu maske + %100 O2 (SpO2 %94-98 hedef)
✓ İleri hava yolundan ÖNCE 30/2
✓ İleri hava yolundan SONRA kesintisiz 100/dk bası
   + dakikada 10 ventilasyon
✓ Uygun ise LMA / ETCO2 takibi

5️⃣ IV/IO YOL:
✓ IV açılamıyorsa: IO (tibia)
✓ Serum fizyolojik açık

6️⃣ 3. ŞOK SONRASI KPR SIRASINDA İLAÇ:
...
💊 AMİODARON
   → 300 mg IV/IO (%5 dekstroz içinde IV puşe)
   → Tekrarlayan/Dirençli VF-nabızsız VT:
     5. şoktan sonra 150 mg IV tekrar
   → AMİODARON yoksa:
     %2 LİDOKAİN 1 mg/kg (LİDOKAİN max 3 mg/kg)

7️⃣ RİTİM DEĞİŞİKLİĞİNDE:
   • Nabız YOK + NEA/Asistoli → Şoklanmaz Ritim (SB-ASH-Y-10) GİT
   • Nabız VAR → Resüsitasyon Sonrası Bakım (SB-ASH-Y-12) GİT
...
• Hipoksi            • Tromboz (koroner/pulmoner)
• Hipovolemi         • Tansiyon pnömotoraks
• Hiper/HipoK        • Tamponad (kardiyak)
• Hipotermi          • Toksin / teröpatik bozukluk
...
⚡ ROSC OLURSA (SB-ASH-Y-12):
✓ Vital tam kontrol, 12 derivasyon EKG
✓ SpO2 %94-98 hedef
✓ Hipotansiyon (sistolik <90): %0.9 NaCl 20 ml/kg bolus
   → devam ederse ADRENALİN 0.1-0.5 mcg/kg/dk
     veya DOPAMİN 5-10 mcg/kg/dk
✓ PVC/R on T/sürekli olmayan VT:
   LİDOKAİN 1-1.5 mg/kg veya AMİODARON 150 mg
   (%5 dekstroz ile 10 dk)"""
    },
    "BRADIKARDI": {
        "aciliyeti": "⚠️ Semptomatik Bradikardi (SB-ASH-Y-07)",
        "algoritma": """📌 TANI: BRADİKARDİ
   (Yavaş Kalp Atışı)
📋 RESMİ PROTOKOL: SB-ASH-Y-07

━━━━━━━━━━━━━━━━━━━━
🚑 SEN NE YAPMALISIN?
━━━━━━━━━━━━━━━━━━━━

1️⃣ ACİL OLGU YÖNETİMİNİ UYGULA:
...
✅ SEMPTOMSUZ / STABİL: Sadece izle, nakil
⚠️ SEMPTOMLU / STABİL DEĞİL: AKTİF müdahale

3️⃣ STABİL DEĞİL İSE (Doktor orderı / KKM):

💊 ATROPİN
   → 0.5 mg IV
   → Yeterli cevap yoksa pacemaker hazırlığına başla:
     • ATROPİN 0.5 mg IV tekrarla (MAKSİMUM DOZ: 3 mg)
     • Yanıt alınamıyorsa:
       ADRENALİN IV infüzyon 2-10 mcg/dk
       veya DOPAMİN IV infüzyon 2-10 mcg/kg/dk
       veya Transkütanöz pace uygula
   ⚠️ QRS > 0.12 sn ise PACE uygulamasını ÖNCELİKLİ düşün

4️⃣ STABİL İSE - ASİSTOLİ RİSKİ VAR MI?
   • Yakın asistoli öyküsü
   • Mobitz Tip II AV blok
   • Geniş QRS'li AV tam blok
   • Ventriküler duraklama > 3 sn
   ✅ VAR → Yukarıdaki tedaviyi uygula (order ile)
   ❌ YOK → NAKİL
...
💊 OKSİJEN → SpO2 <94 ise
💊 SERUM FİZYOLOJİK → TA düşükse 250 ml bolus
...
• Vital her 3-5 dk
• Atropin Mobitz II ve tam blokta ETKİSİZ olabilir
...
• Hipoksemi"""
    ...
    "SVT": {
        "aciliyeti": "⚠️ SVT (Nabızlı Taşikardi - Dar QRS Düzenli - SB-ASH-Y-08)",
        "algoritma": """📌 TANI: SVT
   (Supraventriküler Taşikardi)
📋 RESMİ PROTOKOL: SB-ASH-Y-08 (Dar QRS - Düzenli dalı)

🔍 EKG: Dar QRS (≤0.12 sn)
   Hız 150-250/dk, düzenli

━━━━━━━━━━━━━━━━━━━━
🚑 SEN NE YAPMALISIN?
━━━━━━━━━━━━━━━━━━━━

1️⃣ ACİL OLGU YÖNETİMİ:
✓ Oksijen, damar yolu, monitör, 12 derivasyon EKG
...
4️⃣ TAŞİKARDİ DEVAM EDİYORSA (Doktor orderı / KKM):

💊 ADENOZİN
   → 6 mg IV HIZLI PUSH
   → 20 ml NaCl ile flush
   → Yanıt yoksa 12 mg uygula
   → Yanıt yoksa 12 mg daha uygula
   (ADENOZİN yoksa: METOPROLOL 5 mg veya
    DİLTİAZEM 0.25 mg/kg uygula)
...
6️⃣ NORMAL SİNÜS RİTMİ SAĞLANDI MI?
   ✅ EVET → Uygun merkeze nakil
   ❌ HAYIR → Hız kontrolüne devam

7️⃣ 112 KOMUTA MERKEZİ:
📞 "SVT hastası"
...
• Ani bilinç kaybı → CPR"""
    ...
    "AV_BLOK": {
        "aciliyeti": "⚠️ AV Blok (Bradikardi Protokolü SB-ASH-Y-07)",
        "algoritma": """📌 TANI: AV BLOK
   (Kalp Bloğu)
📋 RESMİ PROTOKOL: SB-ASH-Y-07 kapsamında
...
4️⃣ PARAMEDİK VEREBİLECEĞİ (Doktor orderı / KKM):

💊 OKSİJEN
   → SpO2 <94 ise

💊 ATROPİN
   → 0.5 mg IV (maksimum 3 mg)
   ⚠️ Mobitz II ve Tam blokta
      GENELDE ETKİSİZ!
   Yanıt yoksa:
   → ADRENALİN IV 2-10 mcg/dk
     veya DOPAMİN IV 2-10 mcg/kg/dk
     veya Transkütanöz PACE
   ⚠️ QRS > 0.12 sn ise PACE ÖNCELİKLİ
...
• CPR hazırlığı"""
    ...
    "ASISTOLI": {
        "aciliyeti": "🚨🚨 KARDİYAK ARREST - Asistoli / NEA (SB-ASH-Y-10)",
        "algoritma": """📌 TANI: ASİSTOLİ / NEA
   (Düz Çizgi / Nabızsız Elektriksel Aktivite)
   (Şoklanmaz Ritim)
📋 RESMİ PROTOKOL: SB-ASH-Y-10
...
✓ Kompresyon fraksiyonu en az %60
✓ Göğsün tam gevşemesine izin ver
✓ Hiperventilasyondan kaçın (10/dk)
...
6️⃣ 2 DK ARAYLA RİTMİ VE NABZI DEĞERLENDİR:
   • Nabız VAR → Resüsitasyon Sonrası Bakım (SB-ASH-Y-12) GİT
   • Nabız YOK + NEA/Asistoli → 2 dk KPR'ye devam (döngü)
   • Nabız YOK + VF/NVT → Şoklanır Ritim (SB-ASH-Y-11) GİT
...
• Hipovolemi         • Tansiyon pnömotoraks
• Hiper/HipoK +      • Tamponad (kardiyak)
  metabolik nedenler • Toksin / teröpatik bozukluk
• Hipotermi
...
📋 RESMİ ÇERÇEVE: Acil Olgu Yönetimi (SB-ASH-Y-02)
...
📋 RESMİ: Olay Yeri Yönetimi (SB-ASH-Y-01) +
   Acil Olgu Yönetimi (SB-ASH-Y-02)
