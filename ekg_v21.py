...
BILGI_BANKASI = {
    ...
    "EK_KAYNAKLAR": "Acilci.net EKG Akil Kartlari ve Ankara Universitesi EKG ders notlari referans alinmistir.",
...
app = FastAPI(title="Paramedik EKG", version="21.0")
